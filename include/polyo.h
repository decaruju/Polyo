...
class polyo
{
    public:
        ...
        polyo(const polyo& other){_cells = other._cells; _nonEmpty = other._nonEmpty; _size = other._size; _area = other._area; _cellVector = other._cellVector;}
        ...
        std::vector<cell> liberties(bool,bool);
